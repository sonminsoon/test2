...
@extract($_SERVER);
	...
	$bagData["host"]			= $_SERVER['HTTP_HOST'];
	$bagData["siteName"]		= "이젠의원";			// 상호명
	$bagData["bizNumber"]		=	"312-31-66442";			// 사업자 번호
	$bagData["bizAddr"]		=	"충남 천안시 동남구 만남로 50( 신부동 터미널프라자 7층)";			// 주소
	$bagData["bizCeo"]		=	"이란";																			// ceo
	$bagData["bizTel"]		=	"042-561-7978~9";												// 고객센터
	$bagData["bizFax"]		=	"041-561-7970";												// Fax
	$bagData["copyRight"]		=	"@ 2015 EZEN";							// copyRight

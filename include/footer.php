				...
				<div class="cont_wrap">
					...
					<div id="bottom_counsel" class="item">
						...
						<form action="" method="post" enctype="multipart/form-data" name="wform" class="form" onsubmit="return counselSubmit()">
							...
							<div class="cont01">
								<p class="agree_text">
									<a href="" class="agree_link">개인정보<br>취급방침 보기</a>
					...
					<!-- //bottom_counsel -->
					<a href=""><img src="../images/common/bottom_cont04.jpg" class="item" alt="카톡상담 신청하러가기"></a>
				</div>
			</div>
		</div>
		<!-- sub_bottom_cont -->
	...
	<div id="footer">
		...
		<div class="footer01">
			<div class="footer_cont">
				...
				<ul id="footer_menu02">
					<li><a href=""><img src="../images/common/footer_menu02_01.jpg" alt="오시는길"></a></li>
					<li><a href=""><img src="../images/common/footer_menu02_02.jpg" alt="진료시간"></a></li>
					<li><a href=""><img src="../images/common/footer_menu02_03.jpg" alt="온라인상담"></a></li>
					<li><a href=""><img src="../images/common/footer_menu02_04.jpg" alt="카톡상담"></a></li>
		...
		<div class="footer02">			                     
			<div class="footer_cont">			
				<p class="adress">
				상호: 이젠의원<span class="space"></span>주소: 충남 천안시 동남구 만남로 50 ( 신부동 터미널프라자 7층)<span class="space"></span>대표: 이란<span class="space"></span>전화 : 042-561-7978~9<span class="space"></span>팩스: 041-561-7970<span class="space"></span>사업자등록번호: 312-31-66442
				</p>
				<p class="copyright">

...
<div id="wrap">
	<header>
		...
		<a href="tel:032-438-5800" class="btn_tel">032-438-5800</a>
	</header>
	<!-- gnb -->
	<div id="gnb">
		<p class="top_menu">
		...
		<ul class="gnb_list">
			<li>
				<a href="javascript:void(0);">EZEN 클리닉</a>
				<div class="sub">
					<ul>
			...
			<li>
				<a href="javascript:void(0);">피부센터</a>
				<div class="sub">
					<ul>
			...
			<li>
				<a href="javascript:void(0);">비만센터</a>	
				<div class="sub">
					<ul>
			...
			<li>
				<a href="javascript:void(0);">제모센터</a>					
				<div class="sub">
					<ul>
			...
			<li>
				<a href="javascript:void(0);">리프팅/안티에이징</a>					
				<div class="sub">
					<ul>
			...
			<li>
				<a href="javascript:void(0);">보톡스/필러</a>					
				<div class="sub">
					<ul>
			...
			<li>
				<a href="javascript:void(0);">상담 및 후기</a>					
				<div class="sub">
					<ul>

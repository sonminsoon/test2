		...
		<div class="agreeText">
			<table width="100%" summary="">
				...
				<tbody>
					<tr>
						<td>제목, 실명, 연락처, 이메일</td>
						<td>후기게시판에 후기내용 등록</td>
						<td>1년(후기 목적 달성 확인시)</td>
					</tr>
				</tbody>
			</table>
		</div>
...
<?	}	?>
	...
	<?	for( $i = 0; $i < $boardSet["addfilenumber"]; $i++ ){	?>
			<tr>
				<th><?if($tb=='banner' || $tb=='banner2') echo "배너이미지"; else echo "첨부파일";?><?=$i+1?></th>
				<td>
				<?	if( $Data["savefile"][$i] ) {
	...
	<div class="btnArea3">
		...
		<img src="/board/skin/<?=$boardSet["skin"];?>/images/btn_cancel.gif" align="top" onClick="javascript:history.go(-1)" style="cursor:pointer;" align="absmiddle">
	</div>
</div>
</form>
